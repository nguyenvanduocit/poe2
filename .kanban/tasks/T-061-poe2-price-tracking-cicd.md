...
Pushed commit `ad5827d30c55c2c9fb8e928c2328228eb5ddfef8` to origin/main from `/tmp/poe2-price-ci-push-20260914`, branch `hotfix/poe2-price-tracking`. Latest refresh: 826 Forbidden Rites quotes / 20 categories, master 17,748 records. API đã có thêm Accessories, Armour và Weapons.

HIGH: 24 tests, typecheck, actionlint và `bun run generate` pass (996 routes, link checker 0 errors / 0 warnings). GitHub run: https://github.com/nguyenvanduocit/poe2/actions/runs/34800813113 (SUCCESS: collect, build, typecheck, commit/push đều pass). Cloudflare Pages deployment chưa xác minh hoàn tất. Workspace chính giữ nguyên các bản thảo chưa commit; publication checkout dựa trên origin/main mới nhất.
