...
.claude/skills/pob2/scripts/scripts/analyze.sh "https://mobalytics.gg/poe-2/builds/bear-druid-build"
.claude/skills/pob2/scripts/scripts/analyze.sh "https://poe.ninja/poe2/builds/vaal/character/account/CharName"
.claude/skills/pob2/scripts/scripts/analyze.sh "https://pobb.in/abc123"

# Or use CLI directly with raw POB code
.claude/skills/pob2/.claude/skills/pob2/scripts/pob-cli.sh calc @/path/to/pob-code.txt
```
...
```bash
.claude/skills/pob2/scripts/setup.sh
```
...
```bash
.claude/skills/pob2/scripts/scripts/analyze.sh <url> [command]
```
...
.claude/skills/pob2/scripts/scripts/analyze.sh "https://mobalytics.gg/poe-2/builds/bear-druid-build"
.claude/skills/pob2/scripts/scripts/analyze.sh "https://poe.ninja/poe2/builds/vaal/character/account/CharName"
.claude/skills/pob2/scripts/scripts/analyze.sh "https://pobb.in/abc123" stats
```
...
```bash
.claude/skills/pob2/scripts/scripts/extract-tree.sh <url-or-file> [format]
```
...
```bash
# Summary view
.claude/skills/pob2/scripts/scripts/extract-tree.sh "https://mobalytics.gg/poe-2/builds/bear-druid" summary

# Full JSON
.claude/skills/pob2/scripts/scripts/extract-tree.sh @pob-code.txt json

# All nodes with mods
.claude/skills/pob2/scripts/scripts/extract-tree.sh "https://poe.ninja/..." nodes
```
...
```bash
.claude/skills/pob2/scripts/scripts/fetch-poe2-data.sh
```
...
```bash
.claude/skills/pob2/scripts/scripts/fetch-poeninja.sh <url> [output-file]
```

**Example:**
```bash
# Output to stdout
.claude/skills/pob2/scripts/scripts/fetch-poeninja.sh \
...
```bash
.claude/skills/pob2/.claude/skills/pob2/scripts/pob-cli.sh <command> [pob-code]
```
...
```bash
.claude/skills/pob2/.claude/skills/pob2/scripts/pob-cli.sh calc @/path/to/code.txt
```
...
# 3. Analyze
.claude/skills/pob2/.claude/skills/pob2/scripts/pob-cli.sh calc @build.txt
```
...
```bash
bun .claude/skills/pob2/scripts/pob.ts summary https://pobb.in/8-9u-rZYxc0a
bun .claude/skills/pob2/scripts/pob.ts skills https://pobb.in/8-9u-rZYxc0a
bun .claude/skills/pob2/scripts/pob.ts items https://pobb.in/8-9u-rZYxc0a
```

Or programmatically:

```typescript
import { pobClient } from './.claude/skills/pob2/scripts/pob-client';
...
```bash
# Save both builds
.claude/skills/pob2/scripts/scripts/fetch-poeninja.sh "url1" build1.txt
.claude/skills/pob2/scripts/scripts/fetch-poeninja.sh "url2" build2.txt

# Compare stats
.claude/skills/pob2/.claude/skills/pob2/scripts/pob-cli.sh stats @build1.txt > stats1.json
.claude/skills/pob2/.claude/skills/pob2/scripts/pob-cli.sh stats @build2.txt > stats2.json
```

### Extract skills for documentation

```bash
.claude/skills/pob2/.claude/skills/pob2/scripts/pob-cli.sh info @build.txt | jq '.info.skills'
```

### Check defensive stats

```bash
.claude/skills/pob2/.claude/skills/pob2/scripts/pob-cli.sh stats @build.txt | jq '{life, armour, evasion, fireRes, coldRes, lightningRes, chaosRes}'
```
...
```
.claude/skills/pob2/scripts/
├── SKILL.md           # This file
├── setup.sh           # POB2 installation script
├── .gitignore         # Excludes pob2/ from git
├── scripts/
...
└── pob2/              # POB2 installation (gitignored)
