---
skill_name: trade2
description: "POE2 trade toolkit — search items, price check via playwriter (or CDP Relay) trên trade2 endpoint. Uses your authenticated Chrome session for safe, same-origin API calls. Use for POE2 price checking, item searching, or stat filter lookup."
version: 1.0.0
...
### Live trade2 data (full list with options)
```bash
