...
allowed-tools: Bash(bun scripts/atlas-tree2:*
---
...
```bash
bun .claude/skills/atlas-tree2/scripts/analyze.ts lookup <query>
bun .claude/skills/atlas-tree2/scripts/analyze.ts nearby <id> [count]
bun .claude/skills/atlas-tree2/scripts/analyze.ts distance <id1> <id2>
bun .claude/skills/atlas-tree2/scripts/analyze.ts path <from> <to>
bun .claude/skills/atlas-tree2/scripts/analyze.ts analyze <nodes...>
bun .claude/skills/atlas-tree2/scripts/analyze.ts search-stats <text>
bun .claude/skills/atlas-tree2/scripts/analyze.ts suggest <start> <points>
bun .claude/skills/atlas-tree2/scripts/analyze.ts types
bun .claude/skills/atlas-tree2/scripts/analyze.ts export
bun .claude/skills/atlas-tree2/scripts/analyze.ts masters [name]
bun .claude/skills/atlas-tree2/scripts/analyze.ts subtree <league>
```
