...
#
# Output (both modes): ./data/poedb2/<patch>/<Page>.md
...
OUTPUT_DIR="${ROOT_DIR}/data/poedb2/${PATCH}"
...
# so flatten that constant locale level into the patch root: data/poedb2/<patch>/<Page>.md
...
echo ""
echo "✓ poedb2 mirror updated: ${OUTPUT_DIR}/"
