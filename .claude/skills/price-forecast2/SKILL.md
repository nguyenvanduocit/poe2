...
python .claude/skills/price-forecast2/scripts/collect.py

# Specific league only
python .claude/skills/price-forecast2/scripts/collect.py --leagues "Runes of Aldur"

# Specific items only
python .claude/skills/price-forecast2/scripts/collect.py --items "Divine Orb,Mageblood"
```
...
python .claude/skills/price-forecast2/scripts/forecast.py --type UniqueWeapon,UniqueArmour
...
1. **Collect** history first if no recent data: `python .claude/skills/price-forecast2/scripts/collect.py`
2. **Forecast**: `python .claude/skills/price-forecast2/scripts/forecast.py`
...
5. Check `/trade2` cho actual current listings trước khi acting
