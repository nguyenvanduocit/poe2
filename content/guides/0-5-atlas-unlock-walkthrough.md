...
document_type: guide
title: Mở khóa toàn bộ atlas endgame
status: published
author: duocnv
created: '2026-06-05'
updated: '2026-06-09'
...
**Main atlas tree** là tầng ưu tiên nhất. Patch 0.5.0 trang bị hơn 300 node buff lên mọi map: increased rare monster, magic pack size, tablet effect, essence, shrine. Patch 0.5.1 bổ sung thêm 24 node vào vùng trên cùng của cây, đặc biệt là các biome riêng lẻ — tổng lên hơn 324 node. Đồng thời 0.5.1 tăng số point trao từ Fortress Towers, Gateways, Enigma Chambers và Halls, áp retroactive cho người đã clear rồi. Cày đủ Fortress là dư point để allocate sạch toàn cây.

**Ba Master của Atlas** là tầng buff mạnh nhất — mỗi Master một bộ 12 node chọn-4, swap tự do giữa các map. Mở song song với tree chính theo điều kiện riêng.

**Subtree league mechanic** không bắt buộc: Delirium, Breach, Ritual, Abyss, Fate of the Vaal. Ghét mechanic nào thì bỏ, slot tablet trống tự rải content ngẫu nhiên vào khu, không mất gì. Guide này không đi sâu vào subtree — [Sustain Map Và Setup Atlas Tree Endgame](/guides/0-5-endgame-mapping-sustain) sắp xếp thứ tự subtree theo lợi ích.

## Fortress mọc lên sau khi xong tháp đầu tiên

Vào map đầu tiên, một **Precursor Tower** hiện ngay. Rush hết tower đó thì **Fortress** trồi lên từ đất — khu khổng lồ chứa toàn bộ point main atlas, chia thành **năm section**. Mỗi map bên trong nhả một hoặc nhiều point; các điểm trọng yếu có mũi tên chỉ dẫn, đôi khi cho tới ba point một lần.

Fortress chứa rất nhiều map và trông có vẻ ngợp, nhưng không cần cày từng cái một — có đường tắt xuyên hết cả năm section bằng năm lần kill Arbiter of Divinity, nhanh hơn nhiều.
...
## Ba Master mở thế nào

Ba Master là **Doryani's Science**, **Jado's Spycraft** và **Hilda's Hunting**. Mỗi Master có 12 node xếp thành bốn hàng ba node; chọn-4 cùng lúc, đổi tự do giữa các map qua nút quick-select. Mở từng hàng ba node bằng cách làm mission cho Master đó, và cả ba Master allocate được đồng thời.

Điều kiện mở:

- **Hilda's Hunting** — ghé **Hilda's Campsite** tây-nam chỗ khởi đầu trên atlas là bả tự mở questline.
- **Jado's Spycraft** — hoàn thành một **anomaly map** gần chỗ khởi đầu để mở; toàn questline cần thêm vài anomaly map nữa.
- **Doryani's Science** — clear một **corruption nexus** để mở; quest log liệt kê từng bước tiếp theo.

Vì swap được giữa map nên không có lý do bỏ con nào. Hilda và Jado mở rất rẻ, không có lý do trì hoãn.

## Bật full tree mở gì thêm

Full allocation không chỉ là loot nhiều hơn — nó mở nội dung bị gate sau atlas passive. **Exceptional Items**, **Fracturing Orbs**, và cả **Basic** lẫn **Overseer Precursor Tablet** đều nằm sau node atlas; chưa bật node tương ứng thì những thứ này không xuất hiện. Đây là điều kiện để tiếp cận các lớp craft và farming cao hơn.

Slot tablet để trống thêm league content ngẫu nhiên không-tablet vào khu. Cần full tree để mở nội dung cao cấp, không cần hoàn thành subtree của mechanic không định chạy.
...
- Ba Master của Atlas (Doryani's Science, Jado's Spycraft, Hilda's Hunting) ra mắt.
