...
document_type: guide
title: "League, Standard, SSF và Hardcore: chọn loại nào để chơi"
status: draft
author: duocnv
created: '2026-06-10'
updated: '2026-07-13'
...
:wiki-link{url="https://www.poe2wiki.net/wiki/Private_league"} cho phép tạo một league tách biệt với tên riêng và optional rules tùy chỉnh, chỉ invite người mình muốn vào. Chi phí tính bằng store points (MTX) của GGG — có thể chọn tên league, thời gian bắt đầu, số lượng player, thời hạn và modifier đặc biệt.
...
- **related_guides** [Trading và đổi currency cơ bản](/guides/beginner-trading) — hướng dẫn dùng trade site và Currency Exchange, chỉ có tác dụng khi đang ở trade league (không phải SSF).
- **related_guides** [Content types trong Runes of Aldur](/guides/beginner-content-types) — các loại encounter có mặt trong league hiện tại mà Standard không có.
- **related_guides** [Currency cơ bản: mỗi orb làm gì](/guides/beginner-currency) — hiểu currency trước khi quyết định SSF hay trade giúp đánh giá được chi phí thật của self-sufficient play.
