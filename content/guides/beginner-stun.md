...
- Light Stun xảy ra ngay lập tức theo hit; chance = damage / max life địch (%); hit dưới 15% max life không bao giờ stun.
- Heavy Stun tích buildup qua nhiều hit liên tục — khi đầy, địch đứng im hoàn toàn vài giây; buildup rút nếu không có hit mới.
- Physical và melee mỗi loại cho **50% more stun**; hit vừa physical vừa melee = ×2.25 — nên mace/hammer physical stun tốt tự nhiên.
- Player không tích Stun bar bình thường — chỉ tích khi dùng Raise Shield, Parry hoặc sprint; nếu đầy thì bị Heavy Stun 3 giây.
- Daze (+50% more Stun buildup lên địch); Crushing Blows Heavy Stun ngay địch đang Primed for Stun.
...
Chance dưới 15% bị xử lý như 0 — floor cứng ở đây, hit không đủ mạnh sẽ không bao giờ gây Light Stun. Một hit gây 14% life vẫn = không stun; phải đạt đủ 15% mới bắt đầu có cơ hội.
...
Một hit vừa physical vừa melee (ví dụ đập mace trực tiếp vào mặt địch) nhận cả hai cùng lúc: 1.5 × 1.5 = 2.25 — tức 125% hiệu quả hơn so với hit không phải physical lẫn không phải melee. Vì vậy các build mace/hammer physical có crowd control tốt tự nhiên, không cần mod stun riêng trên gear.

Lưu ý quan trọng: bonus melee chỉ áp dụng cho player, không áp dụng cho monster. Khi địch đập mình bằng melee physical, chúng không nhận double bonus theo cách player nhận — monster melee chỉ cho 33% more (trong khi physical của monster cho 100% more). Con số nghe có vẻ tương tự nhưng hướng áp dụng khác nhau hoàn toàn, nên boss melee physical có thể rất nguy hiểm nếu không có đủ Stun Threshold.
...
:wiki-link{url="https://www.poe2wiki.net/wiki/Daze"} là debuff làm target nhận 50% more Stun buildup từ mọi hit. Áp Daze lên địch trước rồi mới hit là cách đẩy Stun bar nhanh hơn rõ rệt, đặc biệt hữu ích với rare và boss có Stun Threshold cao.

:wiki-link{url="https://www.poe2wiki.net/wiki/Primed_for_Stun"} là trạng thái khi địch đã tích đủ một phần Heavy Stun buildup — normal enemy Primed khi đạt 40% bar, magic 50%, rare 60%, unique 70%. Mechanic :wiki-link{url="https://www.poe2wiki.net/wiki/Crushing_Blows"} là cơ chế cho phép hit tự động Heavy Stun ngay những địch đang ở trạng thái Primed for Stun, thay vì phải kiên nhẫn điền đầy 100% bar. Titan ascendancy passive Crushing Impacts cho "Your Hits are Crushing Blows" — Warrior/Titan vì vậy là class stun mạnh nhất trong game.
