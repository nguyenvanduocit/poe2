...
- Amor Mandragora là unique Changeling Talisman hai tay cho Druid, Level 1 nên equip ngay từ đầu campaign.
- Mechanic chính là Druidic Prowess: buff tối đa 3 lớp, mỗi lớp cho +10% Skill Speed và biến spell hit thành nguồn Rage, tạo loop Rage đổi Skill Speed tự duy trì.
- 3 lớp cho +30% Skill Speed áp đồng thời attack, cast, và warcry; mỗi 20 Rage spent nạp một lớp, rate-limit 0.5 giây mỗi hit khi gom Rage.
- Mod phụ: enemy in Presence bị Hinder giảm 30% move speed, +10-15% Skill Effect Duration không kéo timer Prowess, và +8-15 Int.
- Người dùng chính là Shaman với Commanding Rage cộng Druidic Champion, và Bear/Werewolf shapeshifter; hợp từ campaign tới map mid rồi endgame đổi sang Maji Talisman.

Amor Mandragora là unique :wiki-link{url="https://www.poe2wiki.net/wiki/Changeling_Talisman"} Changeling Talisman — vũ khí hai tay dành riêng cho Druid — với yêu cầu Level 1, nghĩa là có thể equip ngay từ đầu campaign. Mechanic chính là :wiki-link{url="https://www.poe2wiki.net/wiki/Druidic_Prowess"} Druidic Prowess: buff stacking tối đa 3 lớp, mỗi lớp cho +10% Skill Speed và biến spell hit thành nguồn nạp :wiki-link{url="https://www.poe2wiki.net/wiki/Rage"} Rage, tạo loop tự duy trì cho build Druid lai spell với Rage. Item dùng nhiều nhất trên Shaman và các build Druid cần Rage-Skill Speed loop trong campaign đến early endgame.
...
+(8–15) to Intelligence đóng góp stat cho passive tree và gem requirement. Druid sử dụng khá nhiều skill cần Int (Discipline, spell gem, curse), nên flat Int từ weapon không phải slot dead.
...
- **related_mechanics** [Raging Spectre Shaman](/builds/druid/raging-spectre-shaman) — build Shaman dùng Rage + warcry làm hướng scaling, user chính của Amor Mandragora ở meta 0.5.
