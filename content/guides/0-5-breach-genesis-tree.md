...
document_type: guide
title: Breach và hệ craft Genesis Tree
status: published
author: duocnv
created: '2026-06-10'
updated: '2026-06-10'
...
Có một unique tablet đáng biết: **Wraeclast Besieged** giảm pack size của breach trong map 10 tới 20% nhưng cho Unstable Breach thêm 120 giây trước khi sập sau khi thanh đầy. Đây là tablet luyện stabilise cho build chậm — đổi bớt density lấy hai phút dư dả dọn stabilised content và Vruun.

## Chọn map nào để chạy breach

Vùng map quanh **The Monastery of the Keepers** là lựa chọn mặc định: breach có sẵn không tốn tablet, và mỗi map hoàn thành còn trả point cho subtree. Khi đã hết point từ hub và chuyển sang farm thuần, chọn map theo hai tiêu chí. Thứ nhất là layout: breach mở thành vòng lan ra từ tâm, map open layout ít tường ít cầu thang cho mình bám kịp mép vòng — hành lang hẹp hay tầng lớp là tự cắt một nửa quái khỏi tầm đánh. Thứ hai là số mod trên map: Moment of Risk cho wombgift 5% chance lên level theo từng explicit modifier, nên map roll 6 mod vừa juice loot nền vừa đẩy wombgift tier cao — chịu khó roll map xấu một chút, đổi lại nguyên liệu Genesis Tree đẹp hơn.

## Setup farm Breach từ zero

Lộ trình từ chưa có gì tới farm ổn định, mỗi bậc có điều kiện chuyển bậc rõ ràng — đọc xong biết mình đang đứng đâu và nâng gì tiếp.
...
**Bậc 3, tablet hoá mọi map thành map breach.** Bắt đầu roll Breach Tablet nhét vào Map Device mỗi lần mở map — ưu tiên of the Horde và of the Invasion, roll waystone lên 6 affix để có đủ 3 slot. Song song lấy Partial Translation cùng Reverse Transcription nâng tablet lên Rare 4 mod; từ đây breach không còn giới hạn trong vùng hub nữa. Trên subtree, chốt hướng craft và lấy Breeding Program đúng loại wombgift.

**Bậc 4, Genesis Tree và Vruun.** Wombgift đổ về đủ thì dồn vào mở node Genesis Tree, lấy Diverse Control hoặc Growing Wealth hoặc Exquisite Design theo hướng output. Lấy Frantic Invasion cùng Study the Chains để farm Vruun lấy Lineage Support, và Flesh Flower để đem đầu Vruun về mở Grasping Orchid.

**Bậc 5, Breach Domain và pinnacle.** Splinter dư sau Realm Gate giờ dồn stack 300 đổi breachstone tại Genesis Tree. Dùng breachstone mở Breach Domain, lấy nhóm node Hive khi farm trong domain, bật Tear Open the Rift khi dư breachstone. Đích cuối: hạ Tul và Esh trong Fortress lấy chìa khoá đánh Breach Pinnacle Boss — mỗi lần giết pinnacle trả 6 point, quay vòng nuôi nốt phần tree còn trống.
...
**Stabilised Breach và Vruun nặng hơn breach thường.** Cán mốc 100% spawn đống rare cộng boss ngay tại chỗ — và nếu lấy Moment of Risk cùng tablet of the Invasion thì số rare còn dày hơn nữa. EHP mỏng thì đừng đẩy stabilise trong breach density cao đã sẵn đông quái; tablet Wraeclast Besieged là van xả cho giai đoạn này.

**Sky Hive là encounter thủ, không phải clear.** Phải giữ Ailith sống qua nhiều wave — build burst cao nhưng thiếu khả năng giữ khu dễ fail vì để Ailith ăn damage, và lấy Provoke the Swarm là tự tăng áp lực lên cô. Đây là dạng encounter test layered defense hơn là DPS.

**Phụ thuộc Catalyst tạo điểm nghẽn.** Catalyst chỉ ra từ Genesis Tree, build cần nhiều catalyst mà lười chạy Breach sẽ kẹt nguồn — tính trước là farm hay mua, đừng mong catalyst rớt nền như cũ.
...
- Tear Open the Rift thành multichoice bật tắt được; fix lỗi không allocate được node này.
- Rare spawn khi stabilise giờ luôn xuất hiện bất kể Vruun; Vruun spawn sau khi dọn hết rare.
- Item alternate quality từ Catalyst salvage được để thu hồi một phần catalyst.

### Patch 0.5.0 (29/05/2026)

- Breach lên storyline đầy đủ với hub The Monastery of the Keepers; thanh đếm thời gian; 100% kích hoạt Stabilised Breach với boss Vruun, Marshal of Xesht; Breach Atlas Passive Tree viết lại toàn bộ.
- The Genesis Tree ra mắt: tiêu Wombgift + Hiveblood tạo ring/amulet/belt (6+4+4 base mới) + currency, allocate node chọn item craft, bộ caster/minion mod mới trên ring/belt.
- Catalyst không còn rớt từ quái, chỉ lấy từ Genesis Tree; thêm 12 Catalyst mới thêm quality mod cho Jewel.
- Breach Domain với Breach Hive, Sky Hive (thủ Ailith), Fortress (boss Tul và Esh → key Breach Pinnacle); splinter full stack hoá wombgift đặc biệt đổi Breachstone tại Genesis Tree.
- Tablet modifier không còn hoạt động (vd Clasped Hands) bị disable.
