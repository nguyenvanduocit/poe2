...
- ES recovery có hai giai đoạn: delay (2 giây mặc định, rút ngắn bởi "faster start") và rate (33% max ES/giây, tăng bởi "increased Recharge Rate").
- Patch 0.5 cắt hầu hết small node tăng rate, chỉ còn faster start trên tree — rate phải kiếm từ gear.
- Runic Ward (từ Verisium Runeforging) là lớp phòng thủ độc lập, kích hoạt khi life về 1, không bị ảnh hưởng bởi modifier "Defences".
- Ghost Dance cho ~200 ES/giây tại 10k Evasion — không bị nerf theo ES recovery tree.
- Patient Barrier kèm penalty 20% slower start — lấy nó phải đầu tư Runic Ward song song để bù.
...
Tree 0.5 đã loại bỏ hầu hết small node cấp increased rate. Thay vào đó là 30 small node cấp 4% faster start và 23 small node cấp 6% faster start. Các notable còn giữ rate thực sự rất ít. Rapid Recharge hiện là một trong những notable mạnh nhất còn lại với 12% rate + 12% faster start. Convalescence cho 20% faster start nhưng kèm penalty 10% reduced rate. Patient Barrier cho 50% max ES nhưng lại làm chậm start 20%.
...
Deflection là lớp mới nổi bật trong 0.5. Nhiều notable Deflection đồng thời cấp faster start (Mending Deflection cho 20% khi không Full Life, Energising Deflection cho 12%) — nguồn recovery rẻ và hiệu quả nhất trên nhánh Evasion hiện nay.
...
- 0.5 đập mạnh vào rate hơn delay — build chỉ stack faster start sẽ thấy ES hồi chậm rõ rệt khi đã vào rate phase, đặc biệt dưới sustained damage.
...
Pattern recharge spam giữa hai hit boss gần như chết. TTF tăng rõ so với 0.4, và boss có downtime dưới 3 giây không cho đủ thời gian full refill.
