...
**Một — gem level.** Đây là more-multiplier nằm sẵn trên skill: minion more-damage leo theo gem level, ~60% more ở Level 20 và lên ~79% ở Level 30, cộng flat 25% more dành riêng cho Tamed Beast ở mọi gem level. Nó chạm mọi con beast bất kể base, nên +level minion là upgrade ưu tiên số một — nguồn từ amulet, sceptre, helmet (suffix "+# to Level of all Minion Skills"). Jewel **không** cấp gem level; đóng góp minion của jewel nằm ở dòng increased damage và crit-damage-bonus suffix ("of Gripping").
