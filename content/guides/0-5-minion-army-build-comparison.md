...
Phần này đi qua tám trục đo được. Một dòng tóm tắt trước cho dễ định hướng, còn lý do nằm ở prose bên dưới — vì điểm thú vị của so sánh này nằm ở cơ chế, không phải con số.
...
Shaman có trần EHP cao nhất nhưng kèm một lỗ hổng cố hữu. :wiki-link{url="https://www.poe2wiki.net/wiki/Chaos_Inoculation"} cho chaos immunity cộng :wiki-link{url="https://www.poe2wiki.net/wiki/Reactive_Growth"} thích nghi elemental, ES rơi vào 5-6k quanh level 79 và scale lên trần mơ ước 16-17k endgame. Nhưng đúng những ô charm bỏ trống nuôi Sacred Flow lại nghĩa là không có ailment immunity — một lỗ freeze/ignite thật sự. Vương miện Spirit của nó được trả giá bằng đúng cái lỗ phòng thủ này, đó là lý do hướng hardcore/an toàn nhất nghiêng về Infernalist dù trần Shaman cao hơn.
...
Thứ hạng meta ngày-0/ngày-1 là LOW confidence trên cả ba. Đọc "build minion phổ biến nhất" nghiêng về Shaman đến từ web aggregator, không phải dữ liệu ladder đã ổn định — coi mọi claim độ phổ biến là chỉ-hướng, và log lại class/skill distribution thật trên poe.ninja sau tuần đầu.
