...
- Physical bị giảm bởi Armour, Elemental bị giảm bởi resistance, Chaos bị giảm bởi Chaos Resistance — ba hệ phòng thủ hoàn toàn tách biệt.
- Hit và Damage over Time (DoT) là hai dạng khác nhau — penetration và crit chỉ tính cho hit; resistance mới giảm được DoT.
- Magnitude của ailment DoT (Ignite, Bleed, Poison) tính từ damage của hit gây ra nó — tăng hit damage là tăng ailment mạnh hơn.
- Chaos damage lấy đi gấp đôi Energy Shield so với con số thật; Poison stack nhiều lần thay vì ghi đè.
- Conversion đổi damage type và kéo theo ailment — build convert phys sang fire thì Bleed không còn gì để tính magnitude.
...
Physical là loại damage phổ biến nhất, thường đến từ weapon attack. Khác với bốn loại còn lại, Physical bị giảm bởi :wiki-link{url="https://www.poe2wiki.net/wiki/Armour"} — không phải resistance. Tức là build dùng phys damage tốt nhất khi kẻ địch ít armour hoặc khi có source giảm armour trên target.
...
"increased Fire Damage" tăng hit → hit gây ignite mạnh hơn → ignite deal damage cao hơn. Không cần tìm "increased Ignite Damage" riêng. Mọi modifier tăng damage của hit sẽ tự động lan sang ailment DoT xuất phát từ hit đó. Chính vì vậy một build Bleed tập trung tăng flat physical và weapon damage chứ không cần các modifier DoT cụ thể.
...
Thứ nhất: Chaos damage lấy đi **gấp đôi** lượng Energy Shield so với con số damage thật. Một hit 100 chaos damage lấy đi 200 ES. Build chạy ES để phòng thủ sẽ bị chaos damage xuyên qua rất nhanh, nên chaos resistance quan trọng hơn nhiều so với trực giác đầu tiên.
...
Tức là build convert phải kiểm tra ailment ngay. Build convert phys sang fire nhưng vẫn dùng Bleed support sẽ thấy Bleed không có gì để tính magnitude vì không còn phys damage trên hit nữa.
