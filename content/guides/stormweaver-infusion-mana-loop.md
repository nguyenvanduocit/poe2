...
### Phân biệt Infusion Remnant với Remnant của league
...
- Tính sống của build (clear/boss thực tế ở 0.5) chưa kiểm chứng được: chưa character nào chạy live, Comet đã bị nerf ở 0.5 xuống còn 787–1181 damage ở lvl 20 (trước 829–1243), defense mỏng — phải test thực địa khi vào league.[^9][^1]
...
Character passive tree được tinh chỉnh kèm free refund "due to the changes", nên các node mana của engine phải đọc từ export 0.5.0. Comet bị nerf damage: lvl 20 xuống còn 787–1181 từ 829–1243; Fire-Infused cũng xuống còn 787–1181 từ 1036–1554. :wiki-link{url="https://www.poe2wiki.net/wiki/Ice_Nova"} mất khả năng originate từ Frostbolt khi cascade ngang, ảnh hưởng combo clear leveling.[^18][^9] Đây là patch đầu tiên engine đóng vòng được như một league-start plan công khai.[^1]
