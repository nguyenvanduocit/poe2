...
- 0.5.0 halve IL I/II từ 20% xuống 10% max-life; IL III không lấy được nữa — output ignite còn dưới một nửa so với trước patch.
- Ignite là synthesized (no-hit): DPS = 0.02 × max-life minion × magnitude mods × enemy-taken mods.
- Scale qua: more/increased Ignite Magnitude (Searing Flame II nhân đôi), curse và fire exposure. Fire Penetration và crit không có chỗ bám.
- IL không stack khi nhiều companion cùng chạy — chỉ highest applies trên mỗi enemy.
- Self-burn 10%/giây làm vòng Minion Instability chậm gấp ba; sau 0.5.0 IL là damage campaign, không phải engine endgame.
...
Ăn modifier:
- **More/increased Magnitude of Ignite** — hướng damage chính. Mỗi 10% more magnitude là +10% DPS đều.
...
- **Enemy-side res reduction** — :wiki-link{url="https://www.poe2wiki.net/wiki/Elemental_Weakness"} (-40 đến -59% all elemental res) và Fire Exposure. Penetration không có chỗ bám với IL — chỉ enemy-side res reduction mới "xuyên" được fire res.
...
Companion auto-attack là hit thật, nên channel đó ăn đủ Fire Pen, crit, Xoph's Pyre — nhưng đó là damage của đòn đánh companion, không phải của IL ignite. Xoph's Pyre vì vậy chỉ đáng cắm lên skill có hit (Frost Bomb, Storm Mage shock), không phải để bơm IL.
