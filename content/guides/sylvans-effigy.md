...
"Companions deal (50–100)% increased damage to your Marked targets" là damage multiplier có điều kiện: cần Mark target trước. Build dùng :wiki-link{url="https://www.poe2wiki.net/wiki/Voltaic_Mark"} Voltaic Mark hoặc curse-mark tương đương để kích hoạt. Đây là dạng additive với các increased companion damage khác, nên khi character đã stack sẵn nhiều increased thì uplift thực tế của dòng này thấp hơn con số tuyệt đối.
...
Drop từ The Market ở league 0.5. Yêu cầu Level 62 nên không phải item early-game, nhưng cũng không gate tới tận endgame sâu — character có thể equip ngay khi chuyển sang hướng zoo. Giá dao động theo mức độ meta Spirit Walker companion trong mỗi league.

## Version History

### Patch 0.5.1

Fix bug Unique Tamed Beasts gây "Number of shared states is different on client and server" — lỗi ảnh hưởng stability của companion unique beast khi weapon-swap hoặc re-enter zone.
...
- :wiki-link{url="https://www.poe2wiki.net/wiki/Stoic_Sceptre"} Stoic Sceptre — base của item.
- Rare sceptre Spirit cao — thay thế khi không cần dòng "any number" nhưng vẫn muốn đẩy Spirit ceiling.
