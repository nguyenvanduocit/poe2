...
1. Cap cold res 66→75: nguồn cold cố định chỉ còn +15 từ amulet vì bonded Morior chết, penalty −48% phẳng, nên cần ~108 cold từ gear mới — nhiều hơn một dòng lẻ rất nhiều. Gói chung trong đợt đổi hai nhẫn sang Unset Ring ở phần dưới.
...
**Biggest upgrade path:** đổi hai nhẫn sang Unset Ring để lấy 2 skill slot và cap lại phòng thủ — spec chi tiết ngay phần dưới. Cùng với mảng phys EHP, đây là thứ gỡ trần one-shot T15 nhanh hơn bất kỳ điểm DPS nào, vì DPS công khai đã dư từ hai con granted.

## Đổi hai nhẫn sang Unset Ring để lấy thêm 2 skill slot

Cần thêm 2 skill slot cho đàn, mà :wiki-link{url="https://www.poe2wiki.net/wiki/Unset_Ring"} là cách duy nhất nhét slot lên gear — mỗi viên cho đúng một skill slot và không kèm res implicit. Hai nhẫn hiện tại là Storm Circle (Prismatic) với Oblivion Coil (Sapphire), đổi sang Unset là mất cả implicit res lẫn explicit res/Int/life chúng đang gánh, nên đây không phải swap một slot mà phải cân lại nguyên mảng phòng thủ. Bù lại rare ring là slot rare duy nhất roll được dòng minion damage với minion crit, nên hai nhẫn mới vừa lấy slot vừa gánh DPS minion.

Hai chỗ nghẽn định đoạt cách phân bổ. Thứ nhất, **Int bị nhốt trên ring, amulet và helmet** — pool 0.5 không cho Int roll trên găng base evasion, belt hay boot. Int đang 339/339 đệm 0, nên ít nhất một Unset Ring bắt buộc gánh +Int. Dex thì găng cho được, Str thì belt cho được, hai cái này dời dễ; Int là cái kẹt, cũng là gốc của chuyện attribute khó cân vì Chober Chaber cộng thẳng +83 Int requirement rồi convert 40% req sang Dex, đẩy ReqInt lên 339 với ReqDex lên 147. Thứ hai, **cold res 65% đến từ hai nhẫn**. Penalty endgame là −48% phẳng. Storm gánh 40 cold, Oblivion thêm 25, bỏ cả hai thì nguồn cold cố định chỉ còn +15 từ amulet, cold rơi từ 66 xuống ~1. Cap lại cold cần ~108 cold từ gear mới, tức gần 2.5 suffix dành riêng cho cold.

Vì hai chỗ đó, mình chốt **2 dòng minion mỗi nhẫn chứ không 3, và giữ Atziri's Step.** 3 dòng minion mỗi nhẫn ăn hết suffix cho minion thì hết chỗ nhét Int với res, buộc phải bỏ Atziri's Step và mất 30% MS lẫn ~4,700 deflection — Atziri convert 55% evasion sang deflection, gánh phần lớn trong 7,115 deflection hiện tại. DPS công khai đã dư nên dòng minion thứ ba không đáng đổi lấy lớp deflection đó. 2 dòng minion mỗi nhẫn vẫn lên 4 dòng minion tổng so với 2 dòng đang nằm trên Oblivion, vừa đủ suffix cap hết res và giữ nguyên deflection. Mánh để cap đủ là cắm +all Elemental Resistances trên cả hai nhẫn — mod chỉ ring với amulet mới roll, vá fire/cold/light cùng lúc.

Spec từng món, boot Atziri's Step giữ nguyên:

**Ring A — Unset Ring rare.** Suffix Int bắt buộc nằm đây.
- Prefix: Minions deal increased Damage
- Prefix: +100–119 maximum Life
- Prefix: +203–233 Evasion Rating, bù eva mất và nuôi deflection
- Suffix: Minions have increased Critical Damage Bonus
- Suffix: +31–33 Intelligence
- Suffix: +15–16% all Elemental Resistances

**Ring B — Unset Ring rare.** Gánh thêm cold vì cold thiếu sâu nhất.
- Prefix: Minions deal increased Damage
- Prefix: +100–119 maximum Life
- Prefix: +203–233 Evasion Rating
- Suffix: Minions have increased Critical Damage Bonus
- Suffix: +41–45% Cold Resistance
- Suffix: +15–16% all Elemental Resistances

**Găng rare**, giữ base evasion để khỏi tụt eva như Blood Talons đang chạy.
- Prefix: +120–149 maximum Life
- Prefix: % increased Evasion Rating
- Suffix: +34–36 Dexterity
- Suffix: +41–45% Fire Resistance
- Suffix: +41–45% Cold Resistance

**Belt rare**, ưu tiên base life cao và giữ 3 charm slot nếu được.
- Prefix: +150–174 maximum Life
- Prefix: flat Armour, đệ thêm phys EHP chỗ mỏng nhất
- Suffix: +34–36 Strength
- Suffix: +41–45% Lightning Resistance
- Suffix: +24–27% Chaos Resistance

Số ra sau khi đổi, mọi nguồn khác giữ nguyên, penalty −48%: Int lên ~359 dư 20, Dex ~171 dư 24, Str ~135 dư 27 — attribute hết kẹt, sau này swap gear cũng thoải mái. Cold ~85 cap về 75 dư 10 overcap, fire ~79 cap về 75, lightning vẫn cap dư, chaos ~80 cap về 75 — cả bốn res capped. Life nhích từ 1,885 lên ~1,946. Tổng lại được 2 skill slot và 4 dòng minion damage trong khi deflection nguyên vẹn.

Hai chỗ phải verify trước khi mua. Minion damage/crit có roll trên rare ring không và đúng prefix/suffix nào — Oblivion Coil cho thấy minion crit thuộc domain ring, naming jewel "Authoritative…of Gripping" cho thấy minion damage là prefix còn minion crit damage là suffix, nhưng cần xác nhận thẳng trên trade. Và dòng minion thứ hai nên là crit damage hay crit hit chance — crit của Zekoa đang overcap ~24% nên gần như chắc chọn crit damage. Chạy `/trade` lọc `status: securable` rồi rank top-10 theo stat để chốt giá bốn món.
...
Lên kế hoạch đổi hai nhẫn sang Unset Ring lấy 2 skill slot cho đàn, spec đầy đủ ở phần đổi hai nhẫn phía trên. Cân lại lòi ra hai chỗ nghẽn: Int 339/339 đệm 0 chỉ roll được trên ring/amulet/helmet nên một nhẫn phải gánh +Int; cold res 65% đến từ hai nhẫn cũ, bỏ đi thì cold rơi về ~1 và cần ~108 cold từ gear mới mới cap lại. Chốt 2 dòng minion mỗi nhẫn thay vì 3 và giữ Atziri's Step để khỏi mất ~4,700 deflection. Còn chờ verify trên trade chuyện minion roll trên rare ring với prefix/suffix, rồi dò giá bốn món.
