...
- **Thị trường đã sụp và đang sụp tiếp.** +3 reroll từ ~20 div (video tuần trước) còn 6-8 div, pool securable 1625 listing. Mỗi người farm thêm là giá xuống tiếp — vào muộn là cầm hàng rớt giá.
- **Variance craft gate revenue.** Đập 100 cuốn mà đa số ra +1/+2 hoặc mod rác thì revenue thấp hơn nhiều con số "mỗi cuốn 6 div". Cần Partial Translation/Reverse Transcription + roll trúng combo hiếm mới ra cuốn bán div.
- **Không target được ritual tablet khi farm (cách B).** Empty-slot rule rải mọi loại tablet ngẫu nhiên; ritual chỉ ~13-15% lô. Muốn nhiều ritual tablet phải craft thừa hết các loại khác hoặc mua thô.
- **Buyer pool mỏng và nhạy giá.** Chỉ người chạy ritual mới mua, và họ so giá từng listing trong 1600 cuốn. Đặt trên floor là treo hàng.
- **Patch nerf risk.** GGG đã nói sẽ chỉnh cơ chế empty-slot/tablet. Nếu tablet rớt đều bất kể slot, hoặc mod reroll bị hạ trần, engine strat gãy.

## Version History

- **2026-06-24** — Initial draft. Giá live securable qua trade (1 div ≈ 194 ex, mốc 06-18): rare thô floor ~59 ex; +3 reroll 6-8 div (1625 listing); +3 reroll + omen 8-11 div (206 listing). Sửa thẳng claim video tuần trước (+3 reroll "13-25 div" → live 6-11 div, market đã crash + saturate). Stat id mod reroll `explicit.stat_120737942` (*of Prayers*, roll 1-3), omen chance `explicit.stat_4219853180`. Verify cơ chế empty-slot từ patch note 0.5.0; buff ritual 0.5.2 (Chaos Volatile damage cut, Mysterious Rites +10 omen).

## Relationships

- **synergizes_with** [Tablet Supply Farming](/farming/0-5-tablet-supply-farm) — engine cày ra ritual tablet thô (cách B): 3 Irradiated + atlas tablet node + empty-slot rule; doc này craft đầu ra của nó thành cuốn bán div.
