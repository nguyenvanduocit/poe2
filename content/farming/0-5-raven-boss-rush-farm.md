...
- **Entry-price creep** — vé vào là input duy nhất và đang tăng nhanh. Tại 1 div EV còn ~40 div/h; quá ~1,3 div thì farm hết lời. Luôn quote giá reflection live trước khi mua set.
- **Dry streak lỗ thật** — ~20% số set 100 run sẽ hòa hoặc lỗ; set 0 shard mất ~86 div. Chạy dưới 100 run nhân variance này lên.
- **Build floor single-target** — boss rush bắt build hạ pinnacle dưới 2 phút và sống qua Lightning Barrage. Build companion clear-pack thường yếu đúng chỗ này; chậm hoặc chết vừa giảm run/giờ vừa đốt vé.
- **Shard giá volatile** — 06-20 còn ~17k ex, 06-23 đã ~24,8k ex, swing ±30%/ngày. Một set kéo 3 tiếng có thể bán shard vào lúc giá đang tụt.
- **Patch nerf** — farm dựa vào Raven-Touched còn được mọi build thèm. Nếu patch sau hạ giá trị anoint-trên-helmet hoặc tăng nguồn cung shard, cầu sụp và farm mất nền.

## Version History

- **0.5.3 (2026-06-23)** — Initial draft. Shard ~69 div, reflection 1:1 (1 div). EV ~40 div/h; biên mỏng do vé tăng từ ~0,44 div — farm còn +EV nhưng không còn an toàn như trước.
