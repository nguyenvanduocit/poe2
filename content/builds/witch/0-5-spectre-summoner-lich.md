...
0.5.3 sửa bug Spiraling Conspiracy của :wiki-link{url="https://www.poe2wiki.net/wiki/The_Raven's_Flock"} không cập nhật damage khi stat thay đổi. Build này chạy Spark qua spectre Powered Zealot chứ không cast Spiraling Conspiracy, nên fix không tác động trực tiếp, nhưng Raven's Flock retroactively hoạt động đúng hơn cho build nào dùng skill đó.
