...
Điểm khiến nó chơi được — khác hẳn bản theory-craft trước — là **không weapon-swap**. Nguồn Onslaught đến từ việc drain Runic Ward bằng skill của chính mình, nên build không bao giờ swap weapon, tức cái bug desync reservation despawn companion khi swap không bao giờ xảy ra. Một con char thật đã chạy setup này tới Lv93, clear T15 đều, boss ~12M một con. Nó vẫn có một trần rõ: pool máu người chơi mỏng có chủ ý, survivability là chỗ chặn không cho lên cao hơn T15. Hướng cải thiện ở đây là lấy nguyên engine damage của bản này rồi vá đúng hai lỗ phòng thủ mà pilot để ngỏ — cap res và nâng Loyalty lên Romira's.

## Lên 12 companion bằng cách stack reservation efficiency

Sylvan's Effigy là Stoic Sceptre, Spirit 100, Requires Level 6, drop từ Ritual pinnacle boss (không chance ra được). Stat: +54-63% Spirit, allies trong Presence hồi 63.6-64 Life mỗi giây, +9-12 all attributes, companion đánh mục tiêu bị Mark thêm 85-91% damage, grant :wiki-link{url="https://www.poe2wiki.net/wiki/Discipline"} với một con Azmerian Wolf, và dòng định nghĩa cả build "You can have any number of Companions of different types". Effigy gỡ trần *số lượng* — nhưng số con thật sự field được vẫn bị chặn bởi pool spirit, nên mọi thứ sau Effigy là bài toán reservation.
...
- Belt craft Genesis Tree "increased Reservation Efficiency of Minion Skills", helmet roll thêm 8% minion reservation efficiency, cộng vài dòng 10% reservation efficiency rải trên gear.
...
**5. Companion scaling dễ ăn nerf.** GGG vừa cắt Infernal Legion ~50% trong chính patch này; companion damage và reservation efficiency là món hay bị sờ. Cả engine Onslaught dựa Warding Rune of Bodyguards cũng là một dòng đơn lẻ. *Theo dõi hotfix; build có sẵn đường lui về bản carry.*
...
- poe2db.tw — Forgotten Warden (base Primal Markings, grant Spirit Vessel), Warding Rune of Bodyguards, buff Onslaught (`attack_speed_+%` + `base_cast_speed_+%`), bảng reservation Tame Beast (live fetch 2026-06-04).
