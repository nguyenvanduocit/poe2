...
**Swap ở Act 3.** Tame Beast là Lv7 gem nhưng companion thực dụng gánh được quanh **Lv22**, không phải Lv7 — swap ngay Lv22 rủi ro vì chưa đủ passive point. An toàn là chờ Act 3: full respec ~20k gold sang cây companion-support rồi bắt đầu fielding. Pivot này có "playstyle whiplash" và phá vỡ vài support-gem setup — chuẩn bị tâm lý đổi nút một lần.

**Bắt companion (đầu giai đoạn 2).** Rare tame nên nhắm con **Boar**: nó spawn rare cố định (cùng một con roly-poly chậm hơn) ở khu camp đầu, và mục tiêu là roll cho nó **Haste aura** — Haste buff cả mình (đi nhanh hơn) lẫn con carry chính. Tránh con Quadrilla fast-movement ở jungle ruins vì mod tốc độ của nó **khoá không cho roll Haste**. Con đánh chính là một **Unique Tamed Beast** (mở bằng The Natural Order) — đây là heavy-hitter single-target của zoo. Suốt giai đoạn này vẫn **giữ Twister/Ice-Tipped Arrows làm clear** cho tới khi companion đủ mạnh thay thế.
...
**Support-gem tiến hoá (mid).** Đầu giai đoạn cứ basic, rồi nâng dần: chạy **Hulking Minions** cho tới khi anoint được notable **Gigantic** trên cây (Gigantic tự apply cho mọi companion, trả lại slot support); lấy node **Warlord** ("allies regen rage nếu bạn vừa gained rage") — chỉ cần một nguồn **rage-on-hit** (vd rage-on-hit trên chính đòn Parry) là companion có Rage, lúc đó rút Rage III ra cắm support khác. Khi mở reservation node, thêm **Skeletal Cleric** (spirit thấp, heal companion khác) và một skeleton rẻ để bật **Muster** (+7% more damage mỗi loại reviving minion khác nhau đang field). Đủ skeleton thì **Pain Offering** sacrifice tới 2 con thay vì 1, cho buff attack-speed + % damage mạnh hơn.
...
**1. Minion Splash không apply lên native attack của tamed beast → mất AoE-upside, KHÔNG sụp build.** Companion là quái chạy attack pool riêng, không phải player Strike skill, nên Minion Splash (vốn thiết kế cho Skeletal Warrior / Manifested Weapon) có thể không support được. Nhưng vì clear floor đã giao cho Twister giữ xuyên suốt giai đoạn 2, kịch bản xấu nhất chỉ là build dừng ở "zoo single-target cộng một nút Twister quét trash" thay vì "zoo tự clear cả màn" — mất phần ceiling "dễ trúng nhất", không mất khả năng chơi. *Test ngày 1: link Minion Splash lên con strike-beast, đứng trước một pack white, xem strike của nó có splash sang quái bên cạnh không. Quyết định build chạm trần "dễ trúng nhất" hay chỉ dừng ở mức tốt — đây là test ceiling, không phải floor.*
