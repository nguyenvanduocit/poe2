...
Phòng thủ xếp lớp: evasion 8,625 với deflection 7,115 đỡ entry, armour 1,941 cho một lớp phys DR mỏng; ES 1,929 cộng Life 1,885 làm pool, :wiki-link{url="https://www.poe2wiki.net/wiki/Mind_Over_Matter"} đẩy một phần damage sang mana 1,384 thành lớp đệm; :wiki-link{url="https://www.poe2wiki.net/wiki/Ghost_Dance"} hồi ES theo evasion sau khi mất shroud; và một lưới giữ đàn: Loyalty rải redirect, Romira's Requital trên Bear, cộng Periodic Invulnerability Aura của Swarming Wasp pulse cho đàn miễn nhiễm damage từng đợt. Kỷ luật cứng vẫn nguyên: **ở lì weapon set 1, không weapon-swap**. Swap là despawn cả đàn (bug spirit desync chưa fix).
...
:wiki-link{url="https://www.poe2wiki.net/wiki/Wolf_Pack"} (60 spirit flat, ra 7 con sói, level bằng Uncut Spirit Gem) gánh clear với Minion Splash và mang luôn Uruk's Smelting cho break engine. Hai nguồn granted không tốn gem slot lẫn spirit là sub-DPS thật của build: Azmerian Wolf từ Sylvan's Effigy và con Bear từ :wiki-link{url="https://www.poe2wiki.net/wiki/Wild_Protector"} — poe.ninja đo Bear ~126.6k và Azmerian Wolf ~126.9k mà không reserve điểm nào.
...
Năm điểm cuối từ Lv96 tới 100 nên dồn tiếp vào cụm evasion-to-deflection và minion-life đang đi, đừng đụng Glancing Blows gần đó, vì unlucky evade phá thẳng layer entry. Trong cụm đó có một ứng viên mới sau 0.5.3: **Staunch Deflection** (cluster Ranger phía Đông-Nam, qua hai node Deflection + một Evasion Rating) giờ thêm dòng Deflection Rating bằng 8% Evasion Rating. Với evasion live 8,625 thì là +690 deflection, đẩy deflection rating 7,115 lên 7,805 và chance deflect khoảng +2-3pp tuỳ accuracy attacker. Cộng thêm hai dòng cũ "deflected hits không gây Bleeding/Maim" phủ một ailment vector — đây đúng kiểu pickup mà triết lý "DPS dư, vá thủ" muốn. Cái phải trả: từ node hiện đang allocated gần nhất phải đi qua 4 node để chạm Staunch Deflection, nên nó ăn trọn năm điểm cuối Lv96-100 và để lại đúng một điểm cho cụm minion-life. 21 điểm Parry nằm ở weapon-set-2 points, pool tách biệt, dormant là 0 cost.

Verify trong client trước khi cam kết: vào planner, mở cluster Deflection (đi từ vùng Attribute SE qua Deflection → Evasion Rating → Deflection → Staunch Deflection) đếm đúng 4 unallocated nodes, đồng thời đọc deflection rating tab trước/sau ít nhất tăng ~690 mới chắc nó áp vào sheet.
...
Cold 66 là lỗ res duy nhất dưới cap, và phys 4,120 là kênh one-shot mỏng nhất — element max hit đều trên 10k nên không phải vấn đề. Thêm một bẫy gear: ba dòng Bonded cold/light/chaos trên Morior và sceptre là ShamanOnlyMods, Huntress không kích được, nên chúng là số 0 — đừng tính bonded vào res khi craft tiếp. Thứ tự ưu tiên stat là EHP-first: **cap cold 66→75** (rẻ nhất, roll cold trên ring hoặc craft cold belt) → **dày phys EHP** (max hit 4,120 là trần thấp nhất; thêm armour, life-ES flat, hoặc dòng % phys taken as element san về kênh element vốn >10k) → đọc crit% và DPS Zekoa in-client để biết engine crit The Adorned + magic jewel đủ chưa hay cần thêm crit-damage bonus. Lý do thứ tự này và khoảng cách so với phần còn lại của archetype nằm ở Chase tier.

EHP layer order: lưới redirect vào máu đàn (Loyalty rải đàn, Romira's trên Bear) → evasion/deflection entry (eva 8,625 cho evade 48%, deflection 7,115 cho deflect 43%) → armour 1,941 (phys DR 17%, mỏng) → Mind Over Matter (mana đệm) → max res → ES 1,929 cộng Life 1,885 pool → Ghost Dance regen → recovery. Lớp redirect mỏng vì roster không có con nào mang "Damage Taken From Minions First", dồn hết vào Loyalty + Romira's; bù lại Periodic Invulnerability Aura của Swarming Wasp giữ đàn sống qua AoE chaff, còn có phủ tới player hay không thì đọc client mới tính vào EHP của mình. DPS companion không quote số cứng được: PoB2 không model tamed beast, `pob_coverage: PARTIAL` — số đo từ poe.ninja là hai con granted Bear ~126.6k và Azmerian Wolf ~126.9k cộng Wolf Pack ~17.6k; phần Zekoa cộng dàn aura beast đọc bằng quan sát in-client.
...
- **Charm:** ưu tiên Thawing Charm cho freeze (cold 66 dưới cap nên freeze threshold không lý tưởng), phần còn lại đóng các vector ailment.

### Chase tier

Build này vẫn mỏng so với top archetype: EHP 19.4k, trong khi cùng dàn Zekoa + The Adorned + Sylvan's Effigy + Chober Chaber, các con đầu bảng đạt 27-35k. Granted DPS đo được (~253k cho Bear cộng Azmerian Wolf) chỉ đứng giữa bảng, con dẫn đầu chạm 700-880k. Hai lỗ này không đánh đổi nhau — các con vừa tank vừa mạnh nhất đạt cả hai cùng lúc, nên thứ tự nâng cấp xếp theo lợi nhuận:

- **Cap cold 66→75.** Rẻ nhất, một nguồn cold thêm trên ring rare hoặc craft cold lên belt là xong. Lúc Idolatry còn ép thuế -4% all ele mỗi non-idol augment thì cold là kênh ít nguồn nhất nên rớt trước, vá ngay là khép lỗ này.
- **Năm điểm cuối Lv96-100: đi cụm Staunch Deflection.** Sau 0.5.3, Staunch Deflection cấp Deflection Rating = 8% Evasion Rating, tức +690 deflection trên eva 8,625, đẩy deflection 7,115 lên 7,805 và chance deflect +2-3pp tùy accuracy attacker. Cụm cách path hiện tại 4 node (qua hai Deflection + một Evasion Rating + Staunch Deflection), vừa khít với năm điểm cuối; còn lại một điểm cho cụm minion-life. Đúng tinh thần "DPS dư, vá thủ": cú thêm deflection rẻ nhất hiện có mà không tốn currency.
- **Mageblood là đòn EHP đơn lẻ lớn nhất.** Bốn magic flask life/defense bật vĩnh viễn là phần lớn khoảng cách 19.4k → 27k+ của nhóm đầu, đồng thời cap res qua flask (Sapphire cap cold luôn), tách hẳn nhu cầu craft res trên gear nên những slot res hiện tại được nhường lại cho damage/EHP. Đây là món đứng đầu danh sách tiền.
...
### Belt rare minion thay Dusk Lock

Cần ba dòng cùng lúc: **+Level of all Minion Skills**, suffix **"of Ravaging"** cho Minions' Strikes have Melee Splash, và một dòng reservation efficiency (Spirit Reservation Efficiency hoặc Reservation Efficiency of Minion Skills ≥10). Cả combo chưa có cây nào list securable nên là god-roll phải craft hoặc canh dài; riêng +Level of all Minion Skills trên belt đã có sẵn quanh 15-20 div một cây dù mod còn lại rác, đó là sàn giá tham chiếu cho prefix hiếm này.

Đáng tháo cả Dusk Lock vì belt gom ba thứ build đang thiếu vào một slot: +minion level cộng vào nền level đang stack, melee splash cho cả đàn clear, reservation efficiency nới spirit cho bảy con trên pool 439. Khi phải chọn giữa melee splash và reservation efficiency thì lấy **reservation efficiency** (ưu tiên dòng minion-specific roll cao). Spirit là nút thắt build đã hi sinh anoint Gigantic Following để fit, lại được Trusted Kinship nhân thêm, còn splash chỉ tô điểm clear vốn đã 4/5 và không chạm boss.

Ràng buộc giữ nguyên từ Chase tier: Dusk Lock là nguồn cold duy nhất nên bản minion belt đáng tháo phải tự kèm đủ cold giữ cold ≥75, hoặc cap cold từ ring/amulet/jewel (các slot ngoài belt) trước rồi mới tháo. Lưu ý belt slot chỉ chọn được một: minion belt và Mageblood tranh cùng một ô nên không đeo cả hai. Đi minion belt thì bỏ luôn đường Mageblood ở Chase tier; đi Mageblood thì wish belt này coi như huỷ. Search: `https://www.pathofexile.com/trade2/search/poe2/Runes%20of%20Aldur/d8lmO4rvcJ`.

### Helm tiara rare +4 minion level

Tiara rare ôm cùng lúc **enchant +2 Level of all Minion Skills** và **explicit +2** cùng dòng, ra **+4 từ một slot**, kèm life, ele res và 2 rune socket. Thay Skull Corona (+2) thì net thêm +2 minion level mà vẫn giữ được rune reservation efficiency Skull Corona đang mang (dời sang một trong hai socket mới), socket còn lại nhét rune minion damage. Cú nâng này đứng một mình, không cần đợi gì, nhưng cũng là món đắt nhất wish list: full combo đang ~450-585 div (24 listing). Search: `https://www.pathofexile.com/trade2/search/poe2/Runes%20of%20Aldur/G67z6PyZhb`.

### The Hammer of Faith (đã loại)

Ý tưởng ban đầu: tháo Chober Chaber lấy vũ khí phys thuần để The Catha's Balance feed flat nhiều hơn (Hammer 388-582 phys so với Chober 64-116). Tool requirements (`.claude/skills/pob/scripts/requirements.ts`) cho thấy không khả thi.

The Hammer of Faith yêu cầu Str 114, Giant's Blood triple lên **342**. Mod "reduced Attribute Requirements" luôn là **local** (chỉ giảm req của chính item mang nó), nên dòng 35% trên tiara không chạm req của weapon, 342 đứng nguyên. Str live 150, **hụt 192**. Chỉ nguồn global "Equipment and Skill Gems have X% reduced Attribute Requirements" từ notable trên tree (~4% mỗi node) mới hạ được req weapon, mà đổ tới ~35% global (≈9 node) cũng chỉ còn 223, vẫn **hụt 73**.

Int cũng không dư để đổi sang Str khi Chober còn đeo: Giant's Blood triple cả Int req của Chober (113 lên **339**) nên Int 361 chỉ dư 22, không phải vài trăm. Cộng mất ~77 spirit (bỏ một companion) và rune Bonded chết (`enableBondedMods=false`, payoff còn mỗi flat phys feed), swap này là rebuild attribute quanh một vũ khí, không đáng. Giữ Chober Chaber. Search cũ: `https://www.pathofexile.com/trade2/search/poe2/Runes%20of%20Aldur/rP7MLzWrHQ`.
...
**One-shot phys 4.1k.** Phys max hit 4,120 là kênh mỏng nhất — element max hit đều trên 10k, riêng phys T17 slam và pinnacle burst vượt pool là chết bất chấp spreadsheet. Armour 1,941 chỉ cho phys DR 17%; dodge cộng deflection và Mind Over Matter là layer chính. Đây là khoản EHP cần mua tiếp (thêm armour, life-ES flat, hoặc % phys taken as element để chia tải sang kênh element vốn >10k).

**Cold 66 và map mod ele-weakness.** Cold đứng 66, dưới cap 9 điểm — chưa phải tử huyệt nhưng ele-weakness kéo cả ba kênh tụt thì cold lộ ra trước. Vá lên 75 bằng cold trên ring hoặc craft cold belt là rẻ nhất; trong lúc chưa vá thì giữ ele-weakness ra khỏi pool roll map và đeo Thawing Charm phòng freeze.
...
Build cho người thích minion APM thấp: đàn tự đánh, mình giữ hai nhịp phím là mark mỗi 6 giây và Command Wolf mỗi 15 giây, còn lại là di chuyển để né. Triết lý chi tiêu spirit đã chốt: một carry crit, dàn aura bot, mọi sub-DPS phải miễn phí. Hiện trạng là build farm T15-16 thoải mái chứ chưa phải shell tank pinnacle deathless. EHP 19.4k vẫn mỏng so với top của archetype, phys max hit 4,120 là trần one-shot thấp nhất, cold đứng 66 dưới cap 9 điểm là lỗ rẻ nhất phải vá. Trần pinnacle vẫn nằm trong chính archetype này: cùng dàn Zekoa + The Adorned + Sylvan's Effigy + Chober Chaber, các con đầu bảng đạt EHP 27-35k và granted DPS 700-880k nhờ Mageblood cộng jewel minion/companion damage và max ES, nên hướng đẩy tiếp là leo lên đó chứ không phải đổi build (xem Chase tier). Số DPS của Zekoa là quan sát in-client vì PoB2 chưa model tamed companion.

## Changelog

### 2026-06-30

- Wish list mở rộng ba target. (1) Belt rare minion thay Dusk Lock: +minion level cộng suffix "of Ravaging" Melee Splash cộng reservation efficiency; khi phải chọn thì reservation eff hơn splash (query d8lmO4rvcJ). (2) Helm tiara rare +4 minion (enchant +2 cộng explicit +2), full combo ~450-585 div, đứng một mình không cần đợi (query G67z6PyZhb). (3) Loại The Hammer of Faith sau khi build tool requirements.ts (.claude/skills/pob/scripts/) đọc export: reduced-attribute-requirement luôn LOCAL nên tiara không hạ req weapon, Str hiệu dụng đứng 342 (114×3 Giant's Blood), Str live 150 hụt 192 (kể cả đổ 35% global tree-reduced vẫn hụt 73). Int không dư để đổi sang Str vì Giant's Blood triple cả Int req Chober (113→339) nên Int 361 chỉ dư 22. Cộng mất ~77 spirit và Bonded chết (enableBondedMods=false), không đáng, giữ Chober. Sửa lỗi belt slot: minion belt và Mageblood tranh cùng ô belt nên không cap cold bằng Mageblood khi đã đeo minion belt.

### 2026-06-19

- Patch 0.5.3: Staunch Deflection thêm dòng Deflection Rating bằng 8% Evasion Rating. Live snapshot 2026-06-14 (Eva 8,625 / Defl 7,115) suy ra +690 deflection nếu allocate. Cluster cách path hiện tại 4 node (qua Deflection + Evasion Rating + Deflection + Staunch Deflection) nên ăn trọn năm điểm cuối Lv96-100 — đúng cú vá thủ rẻ nhất trước khi nghĩ tới Mageblood. Sync defense về live: armour 1,941 / eva 8,625 (48%) / defl 7,115 (43%), Life 1,885 / ES 1,929, res F72/C66/L75/Ch72, EHP 19,432, phys max hit 4,120. Granted DPS đo lại: Bear 126.6k / Azmerian Wolf 126.9k / Wolf Pack 17.6k. Chase tier reorder: cap cold 66→75 trước, rồi năm điểm cuối tree đi Staunch Deflection, rồi Mageblood, rồi support Bear, rồi engine rage tập trung, rồi re-point jewel.
