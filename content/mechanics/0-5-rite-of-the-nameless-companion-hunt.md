...
Còn một trục thứ ba ngoài tablet: **empowerment qua Summoning Circle**. Một :wiki-link{url="https://www.poe2wiki.net/wiki/Summoning_Circle"} trong map cộng atlas notable **Runic Flare** cho 10% chance nâng con map boss thành Powerful Map Boss mỗi khi hoàn thành vòng tròn — empower từng con boss target mà không tốn slot Overseer tablet. Ba trục chia việc rạch ròi: Rite quyết **số lần** con boss xuất hiện, tablet "of Contest" cùng :wiki-link{url="https://www.poe2wiki.net/wiki/Cruel_Hegemony"} quyết **số mod** mỗi lần, summoning circle **empower** mỗi lần. Trạng thái Powerful tăng sức mạnh và loot con boss; nó có cộng modifier tameable hay làm con tame mạnh hơn không thì để log — chi tiết empowerment gom ở [Nhồi Rare Modifier Lên Unique Tamed Beast](/mechanics/crafting/0-5-tame-unique-beast-modifiers).
...
- **2026-06-09** — Thêm cross-ref trục empowerment. Summoning Circle cộng atlas notable Runic Flare empower con map boss target thành Powerful Map Boss — đường miễn phí ngoài Overseer tablet. Ba trục săn boss: Rite = số lần spawn, tablet = số mod mỗi spawn, summoning circle = empower mỗi spawn. Chi tiết empowerment ở doc Nhồi Rare Modifier Lên Unique Tamed Beast.
