...
Sai — viết build-around quanh một trong 19 item vỏ datamine vì thấy tên hay. Đúng — đợi stat populate rồi mới commit. Lý do — chưa có mod nào để build, mọi kế hoạch dựa trên page rỗng đều vô căn cứ cho tới khi stat populate.
