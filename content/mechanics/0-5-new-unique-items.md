...
title: Unique Items Mới & Meta Shift
status: draft
author: duocnv
created: '2026-05-25'
updated: '2026-05-25'
...
Mua sớm Mageblood hay Loreweave vì nhớ chúng OP ở POE1 là cách tốn div nhất tuần đầu league — GGG re-design toàn bộ port, tên giống không đảm bảo cơ chế giống, đọc mod 0.5 từ poe2db trước khi bid.

Build-around quanh một trong 19 item vỏ datamine vì tên hay cũng là bẫy tương tự — chưa có mod nào để build, mọi kế hoạch dựa trên page rỗng đều vô căn cứ cho tới khi stat populate.
