...
## Delirium, Breach, Ritual được nâng thành storyline đầy đủ
...
## Crafting economy: Expedition tắt, Recombinator gỡ, currency xáo lại
...
Currency tier cũng xáo lại. Greater và Perfect currency hiếm hơn một chút, riêng Transmutation và Augmentation hiếm hơn đáng kể; bù lại Greater Orb of Transmutation và Augmentation hạ Modifier Level tối thiểu xuống 44, trước là 55, và bắt đầu rớt từ Act 4, còn Divine Orb phổ biến hơn. Omen of Corruption không còn lấy được. Tổng thể leveling craft dễ tiếp cận sớm hơn, nhưng end-game craft bằng recombination thì biến mất.

## Martial Artist và Spirit Walker, hai ascendancy mới

**Martial Artist** là ascendancy thứ ba của Monk: bậc thầy ảo ảnh, dùng rune khắc vào cơ thể để tạo illusion, triệu illusory bell trợ chiến, và đánh chủ lực bằng tay không. Class này ăn khớp trực tiếp với unique [Facebreaker](/mechanics/items/facebreaker) — gloves cho phép dùng mace skill bằng tay không. Patch buff thẳng nền tảng combo: :wiki-link{url="https://www.poe2wiki.net/wiki/Tempest_Bell"} giờ giữ tối đa 3 bell active, trước là 1, và Ancestrally Boost được như Strike skill, nên đường Monk bell mạnh hơn rõ ngay từ đầu.
...
**Infernal Legion ăn nerf nặng, ảnh hưởng trực tiếp note build mình có.** :wiki-link{url="https://www.poe2wiki.net/wiki/Infernal_Legion"} III **không còn lấy được nữa**, còn I và II đều bị cắt đôi: minion nhận 20% xuống 10% maximum Life as Fire Damage mỗi giây, và ignite cũng giảm từ 20% xuống 10% Minion's Maximum Life dưới dạng Base Fire Damage — radius giữ nguyên 1.5m (I) / 2m (II), II được bù +20% Fire Resistance cho minion. Build [Dinomancer Lich Elephant](/builds/witch/dinomancer-lich-elephant) dựa trên ignite loop của Infernal Legion — mất tier III nghĩa là mất một bậc scaling, và self-damage giảm một nửa làm chậm cả ignite engine lẫn vòng Minion Instability. Đây là việc cần đánh giá lại sớm tuần đầu league, không phải để đó.

**Minion build có cả buff lẫn công cụ mới.** Hai support gem **Minion Splash** và **Minion Splash II** mới cho minion strike có Melee Splash — mở khả năng clear cho minion melee. Tame Beast được buff mạnh (xem trên). Cơ chế gỡ minion khi đổi weapon set giờ ưu tiên minion mới trước minion cũ, tránh phí cooldown ability, và Minion Instability đã được fix để không còn bypass Last Gasp. Cộng lại, minion-summoner vẫn là archetype khỏe — chỉ riêng nhánh dựa Infernal Legion ignite là phải dè chừng.

**Pool unique nở rộng, vài cái đáng để mắt.** :wiki-link{url="https://www.poe2wiki.net/wiki/Mageblood"} xuất hiện trong danh sách unique mới của Path of Exile 2 — belt định nghĩa cả meta endgame ở Path of Exile 1, nên sự xuất hiện của nó ở đây là tín hiệu lớn. Loreweave và Geofri's Sanctuary cũng là tên quen từ PoE1 quay lại. :wiki-link{url="https://www.poe2wiki.net/wiki/The_Hollow_Mask"} được rework — giờ cấp skill Wildwood's Gifts và 80-100% increased Reservation Efficiency of Remnant Skills. Hai unique reveal trước launch là [The Auspex](/mechanics/items/the-auspex) (single-minion utility, Mist Raven) và [Facebreaker](/mechanics/items/facebreaker) (empty-hand mace, khớp Martial Artist).
...
- **Infernal Legion minion build hậu nerf** — đo lại ignite DPS thực tế của [Dinomancer Lich Elephant](/builds/witch/dinomancer-lich-elephant) sau khi mất tier III; quyết định pivot support hay đổi archetype.
...
- [Patch Notes 0.5.0](/mechanics/leagues/0-5-0-patch-notes) — changelog đầy đủ từng dòng để tra cứu thay đổi cụ thể.
- [Spirit Walker Companion Beast Hunt](/mechanics/spirit-walker-companion-beast-hunt) — đào sâu ascendancy companion mới.
- [The Auspex](/mechanics/items/the-auspex) và [Facebreaker](/mechanics/items/facebreaker) — hai unique reveal trước launch.
- [Dinomancer Lich Elephant](/builds/witch/dinomancer-lich-elephant) — build chịu tác động trực tiếp từ nerf Infernal Legion.
...
- **derived_from** [Patch Notes 0.5.0](/mechanics/leagues/0-5-0-patch-notes) — bản tóm tắt định hướng đã digest từ changelog đầy đủ của patch này.
- **related_mechanics** [Spirit Walker Companion Beast Hunt](/mechanics/spirit-walker-companion-beast-hunt) — Spirit Walker là một trong hai ascendancy mới ra mắt cùng patch 0.5.0.
