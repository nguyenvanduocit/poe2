...
:wiki-link{url="https://www.poe2wiki.net/wiki/Armour"} là defence cấp physical damage reduction theo công thức `DR = A / (A + 10 × D_raw)` với cap 90% — tooltip chỉ hiện một con số armour phẳng, nhưng % giảm thực tế phụ thuộc tỉ lệ giữa armour và độ lớn của cú hit, nên hai character cùng 200k armour chịu hai cú hit khác cỡ sẽ giảm sát thương khác nhau. Patch 0.5.0 "Runes of Aldur" tăng lượng armour mà item và modifier cấp ở level cao — khoảng 33% more ở level 65, giảm dần xuống 15% more ở level 80+ — đồng thời quét gần như toàn bộ recovery layer của :wiki-link{url="https://www.poe2wiki.net/wiki/Energy_Shield"} (xem [Energy Shield Recovery Rework](/mechanics/energy-shield-recovery-rework)). Chassis dùng armour làm primary defence là Warrior/Titan stacker — class có sẵn strength scaling và notable cộng armour — nhưng vì base scaling được nâng floor, bất kỳ class nào có một synergy armour nhỏ cũng đủ tank physical hit thường ở tier 15-16 mà không cần build chuyên. League launch 29/05/2026, nên quyết định defence layer phải chốt trong tuần này: ES recovery nerf đẩy nhiều build ES-primary cũ phải pivot, và armour là điểm đến rõ ràng nhất cho physical mitigation.
...
- **related_mechanics** [Energy Shield Recovery Rework](/mechanics/energy-shield-recovery-rework) — nửa còn lại của cuộc rebalance defence 0.5; ES recovery bị nerf trong khi armour được nâng floor, hai doc đọc cùng nhau cho bức tranh đầy đủ tương quan defence layer.
