...
const TABS: Tab[] = [
    ...
    groups: [
      {
        ...
        intent: 'roll',
        blurb: 'Roll theo dòng mod thật (search được); affix name ở dưới. Thứ tự cho farm logbook.',
        rows: [
          { text: '(15–30)% increased Quantity of Expedition Logbooks dropped by Runic Monsters in Map', note: 'of Knowledge — mod số 1, nguồn sustain logbook.' },
          { text: 'Expeditions in Map have +(1–2) Remnant', note: 'of the Writings — thêm suffix reward + chỗ craft.' },
          { text: '(25–40)% increased number of Rare Expedition Monsters in Map', note: 'of Ancient Fiends — thêm rare = thêm loot + runic.' },
          { text: '(15–30)% increased quantity of Expedition Artifacts dropped by Monsters in Map', note: 'of Verisium — tiền vendor.' },
          { text: '(12–18)% increased Effect of Expedition Remnants in Map', note: 'of Relics — risk-reward, chỉ lấy khi build gánh nổi remnant mạnh.' },
          { text: '(15–30)% increased Expedition Explosive Radius / Placement Range in Map', note: 'of the Demolition / of the Detonator — QoL, lấy sau cùng.' },
        ],
      },
    ],
  },
  {
    ...
    groups: [
      {
        heading: 'Subtree Expedition (8 point) — nuôi logbook',
        intent: 'pick',
        blurb: 'Rarity stack để runic monster thành Rare = nhiều logbook hơn.',
        rows: [
          { text: 'Logbook Chance ×8', note: '5% increased Quantity of Expedition Logbooks dropped by Runic Monsters mỗi small node — nền sustain.' },
          { text: 'Strategic Advantage', note: 'Explosive chỉ chờ 50% quái chết → chain nhanh; Runic Monster spawn thiếu sẵn 20% life.' },
          { text: 'Double or Nothing', note: '25% chance Verisium Remnant thêm 1 Runic Modifier → tăng chance rớt logbook.' },
          { text: 'Calculated Investment', note: 'Chọn 25% Verisium Remnant tính như có Power Rune (loot) / +XP / +Quantity mỗi Runic Modifier.' },
          { text: 'Steady Development → Explosive HOẶC Remnant', note: 'Explosive = thêm quả nổ, dọn runic nhanh, hợp budget + layout xấu. Remnant = thêm Verisium Remnant = nhiều reward slot, hợp full Grand Expedition.' },
          { text: 'Buried Ambition', note: 'Expedition sinh Verisium Sentries; rune từ Sentry + Verisium Remnant áp lên cả quái expedition → thêm loot + logbook.' },
          { text: 'The Quest Continues', note: 'Grand Expedition tối đa 3 Modifier + +1 Area Level.' },
        ],
      },
      {
        heading: 'Cultivate the Sea → ép Ocean thành Desert',
        intent: 'pick',
        blurb: 'Ocean/Island tính là một Biome nữa. Chọn Desert cho rare-monster juice.',
        rows: [
          { text: 'Cultivate the Sea → Desert', note: 'Chọn Desert trong 6 biome (Water/Mountain/Grass/Forest/Swamp/Desert).' },
          { text: 'Desert small: 20% Rare Monster + 5% Pack Size', note: 'Thêm rare = thêm runic rare = thêm logbook.' },
          { text: 'Desert Mastery → 15% Monster Effectiveness', note: 'Áp lên mọi quái trong ocean map.' },
          { text: 'Desert notable: rare pack juice', note: 'Rare pack Desert: 100% chance có Additional Rare Monster (hoặc 1 rare doubled Effectiveness) + 50% chance thêm Monster Modifier.' },
        ],
      },
      {
